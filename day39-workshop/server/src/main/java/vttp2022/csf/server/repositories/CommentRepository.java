...
public class CommentRepository {
    ...
    public Optional<List<String>> getCommentsByCharacterId(Integer characterId) {
        ...
        // query results
        List<Document> results = mongoTemplate.find(q, Document.class, COMMENT_COLLECTION);
        ...
        System.out.println("%d comments found for character: %d".formatted(comments.size(), characterId));
